    ...
    >
      ...
      >
        <KPI
          ...
          delta={`${stats?.revenueGrowth || 0}% ${t("common.yesterday")}`}
          dir={Number(stats?.revenueGrowth) >= 0 ? "up" : "down"}
          icon="💰"
          color="var(--accent)"
        />
        <KPI
          ...
          delta={`${stats?.ticketGrowth || 0}% ${t("common.yesterday")}`}
          dir={Number(stats?.ticketGrowth) >= 0 ? "up" : "down"}
          icon="🎟️"
          color="var(--blue)"
        />
        <KPI
          label={t("dash.todayShows")}
          value={stats?.liveShows || 0}
          delta={t("show.live")}
          dir="up"
          icon="📽️"
          color="var(--green)"
      ...
      >
        ...
        <div className="cp-card" style={{ padding: 20 }}>
          ...
          >
            ...
            >
              ₹
              {(revenueData.reduce((s, d) => s + d.revenue, 0) / 1000).toFixed(
                1,
              )}
              K total
            </div>
      ...
      <div className="cp-card" style={{ overflow: "hidden" }}>
        ...
        >
          ...
          <Link href="/dashboard/shows" className="btn btn-ghost btn-sm">
            View All →
          </Link>
        </div>
              ...
              {todayShows.length === 0 ? (
                ...
                todayShows.map((show: any) => (
                  <tr key={show.id}>
                    ...
                    <td>
                      <span
                        className={`badge badge-${show.status.toLowerCase()}`}
                      >
                        <span
                          style={{
                            width: 5,
                    ...
                    <td>
                      <Link
                        href={`/dashboard/pos?showId=${show.id}`}
