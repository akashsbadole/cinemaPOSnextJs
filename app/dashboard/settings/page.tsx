  ...
  return (
    ...
    >
      ...
      <div className="cp-card" style={{ overflow: "hidden" }}>
        ...
        <div
          style={{ padding: 20, display: "flex", gap: 32, flexWrap: "wrap" }}
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <input
              ...
              onChange={(e) =>
                setSettings({
                  ...settings,
                  RAZORPAY_ENABLED: String(e.target.checked),
                })
              }
            />
            <label
              htmlFor="razorpay-enabled"
              style={{ fontSize: 13, fontWeight: 500 }}
            >
              Enable Razorpay Online Booking
            </label>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <input
              ...
              onChange={(e) =>
                setSettings({
                  ...settings,
                  SMS_ENABLED: String(e.target.checked),
                })
              }
            />
            <label
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <input
              ...
              onChange={(e) =>
                setSettings({
                  ...settings,
                  EMAIL_ENABLED: String(e.target.checked),
                })
              }
            />
            <label
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <input
              ...
              onChange={(e) =>
                setSettings({
                  ...settings,
                  WHATSAPP_ENABLED: String(e.target.checked),
                })
              }
            />
            <label
            ...
            >
              <input
                ...
                onChange={(e) =>
                  setSettings({
                    ...settings,
                    AUTO_SEND_REMINDER: String(e.target.checked),
                  })
                }
              />
              <label
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      REMINDER_HOURS_BEFORE: e.target.value,
                    })
                  }
                />
              </div>
      ...
      {[
        {
          ...
          fields: [
            {
              label: "Business Name",
              placeholder: "CinePlex Multiplex",
              type: "text",
            },
            {
              label: "GST Number",
              placeholder: "27AAACM1234A1ZA",
              type: "text",
            },
            {
              label: "Contact Email",
