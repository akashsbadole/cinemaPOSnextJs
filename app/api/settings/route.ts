...
const NOTIFICATION_KEYS = [
  ...
  'RAZORPAY_KEY_ID',
  'RAZORPAY_KEY_SECRET',
  'CANCELLATION_PROTECT_ENABLED',
  'CANCELLATION_PROTECT_FEE',
  'CANCELLATION_PROTECT_REFUND_PERCENT',
]
...
const NOTIFICATION_DEFAULTS: Record<string, string> = {
  ...
  CANCELLATION_PROTECT_ENABLED: 'true',
  CANCELLATION_PROTECT_FEE: '25',
  CANCELLATION_PROTECT_REFUND_PERCENT: '80',
}
